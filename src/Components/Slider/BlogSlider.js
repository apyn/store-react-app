...
const BlogSlider = () => {
    return ( 
        <section className="container mx-auto mb-6">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center md:justify-between md:items-center bg-white p-4 gap-x-4 mb-4 md:shadow-md dark:shadow-slate-700 rounded-md dark:bg-slate-700 dark:text-zinc-300 ">
