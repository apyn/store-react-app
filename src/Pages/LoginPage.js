    ...
    return ( 
        <section className="flex justify-center items-center container mx-auto p-4 mt-8 ">
            <form onSubmit={formik.handleSubmit} className="ring-1  ring-gray-300 rounded-md w-96 flex flex-col  p-4">
                ...
                <p className="text-slate-700 mb-4 dark:text-zinc-300"> ورود به پنل کاربری</p>
                <div className="flex flex-col mt-4  dark:text-zinc-300">
                    <label className="text-slate-500 text-sm  dark:text-zinc-300">ایمیل یا شماره موبایل را وارد کنید </label>
                <input     
            ...
            <button type="submit" className="bg-indigo-700 text-white dark:text-zinc-300 font-bold px-4 py-3 mt-6 rounded-md">ورود</button>
          ...
          <Link to="/signup" className="dark:text-zinc-300"> ثبت نام</Link>
          <Link className="dark:text-zinc-300">فراموشی رمز عبور</Link>
          </span>
            </form>
        </section>
     );
