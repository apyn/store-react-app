      ...
      <section className="flex flex-col ring-1 ring-gray-300 rounded-md  w-8/12">
        ...
        {cart.length ? (
              ...
              <div className="flex border-b-2 border-solid border-gray-300 p-2">
                <div className="p-2">
                  ...
                  <div className="mt-4 text-center flex items-center justify-center">
                    <span
                      ...
                      className="bg-transparent text-rose-500 font-bold py-2 px-3 border-t-2 border-b-2 border-r-2 border-solid border-gray-300 outline-none rounded-r-md cursor-pointer"
                    >
                      +
                    </span>
                    <span className="bg-transparent text-rose-500 font-bold py-2 px-3 border-t-2 border-b-2 border-solid border-gray-300 outline-none ">
                      {item.quantity}
                    </span>
                    <span
                      onClick={() => removeHandler(item)}
                      className="bbg-transparent text-rose-500 font-bold py-2 px-3 border-t-2 border-b-2 border-l-2 border-solid border-gray-300 outline-none rounded-l-md cursor-pointer"
                    >
                      <HiOutlineTrash className="h-6 w-5" />
                    </span>
                  </div>
                </div>
                <div className="flex flex-col gap-2 p-2">
                  ...
                  <div className="flex items-center">
                    ...
                    <p className="text-xs text-gray-500 mr-2">قرمز</p>
                  </div>
                  <div className="flex items-center">
          ...
          <div className="flex flex-col gap-y-4 items-center justify-center">
            ...
            <Link
              className="text-sm text-rose-500 hover:text-rose-700 hover:font-extrabold mb-6"
              to="/"
            >
              صفحه اصلی
            </Link>
